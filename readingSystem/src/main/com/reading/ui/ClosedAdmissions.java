...
public class ClosedAdmissions extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
		...
		}, new String[] { "Student ID","Name", "Address", "Mobile No.", "Altrenate Mo. No.", "Parents Mo. No.", "Qualification",
				"Occupation", "Joining Date", "Admission Type", "Shift Type", "Fee Status", "Last fee Paid",
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
												.addComponent(reOpenBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 126,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(18, 18, 18).addComponent(deletBtn,
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(reOpenBtn)
	...
	private void reOpenBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_reOpenBtnActionPerformed
		...
		try {
			record.put("ID", (String) table.getValueAt(table.getSelectedRow(), 0));
			...
			if (new Student().update(record)) {
				...
				JOptionPane.showMessageDialog(this, "Student admission Activated sucessfully !", "Sawant Balaji",
						JOptionPane.INFORMATION_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(this, "Admission not activated, Something went wrong...", "Sawant Balaji",
	...
	private void deletBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_deletBtnActionPerformed
		...
		try {
			record.put("ID", (String) table.getValueAt(table.getSelectedRow(), 0));
			if (new Student().delete(record)) {
				new ActionTrackerHM("Student record deleted from closed admission",
						(String) table.getValueAt(table.getSelectedRow(), 0));
				JOptionPane.showMessageDialog(this, "Student Record deleted sucessfully !", "Sawant Balaji",
						JOptionPane.INFORMATION_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(this, "Could not delete record, Something went wrong...", "Sawant Balaji",
						JOptionPane.ERROR_MESSAGE);
			}
			((DefaultTableModel) table.getModel()).setRowCount(0);
			new SetAllTable().setClosedAdmissionsTable(table);
